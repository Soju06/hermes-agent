...
class TestDelegationCredentialResolution(unittest.TestCase):
    ...
    def test_provider_override_beats_config_provider(self, mock_resolve):
        ...
        mock_resolve.return_value = {
            "model": "grok-4.3",
            "provider": "grok-tokenmaxxing",
            "base_url": "https://grok.tokenmaxxing.party/v1",
            "api_key": "grok-key",
        ...
        creds = _resolve_delegation_credentials(
            ...
            provider_override="grok-tokenmaxxing",
        )
        mock_resolve.assert_called_once_with(
            requested="grok-tokenmaxxing", target_model="grok-4.3"
        )
        self.assertEqual(creds["model"], "grok-4.3")
        self.assertEqual(creds["provider"], "grok-tokenmaxxing")
        self.assertEqual(creds["base_url"], "https://grok.tokenmaxxing.party/v1")
        self.assertEqual(creds["api_key"], "grok-key")
...
class TestDelegationProviderIntegration(unittest.TestCase):
    ...
    def test_per_call_model_provider_reach_child_agent(self, mock_creds, mock_cfg):
        ...
        with patch("run_agent.AIAgent") as MockAgent:
            ...
            self.assertEqual(kwargs["provider"], "grok-tokenmaxxing")
            self.assertEqual(kwargs["base_url"], "https://grok.tokenmaxxing.party/v1")
