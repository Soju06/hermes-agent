...
signals should produce "Nothing to save." rather than synthetic skill churn.
...
def test_memory_review_prompt_requires_structured_reason_contract():
    """Background memory review must know the same rationale gate as foreground memory writes."""
    prompt = AIAgent._MEMORY_REVIEW_PROMPT
