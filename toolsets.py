...
TOOLSETS = {
    ...
    "hermes-a2a": {
        "description": "A2A (Agent2Agent) peer-to-peer toolset - bot-to-bot communication via the A2A protocol (no chunking, no streaming-edit artifacts, single-turn replies)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
