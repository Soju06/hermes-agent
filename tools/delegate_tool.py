...
def delegate_task(
    ...
    # Internal callers such as /review may supply a per-call credential
    # override. Resolve that eagerly so the override is validated before any
    # task construction; model-facing calls retain the lazy config path below.
